...
This directory contains the native Laravel 12 and Filament 5 application for LMS. It can run as a conventional Laravel deployment or be packaged as a static browser demo that executes PHP 8.4, Laravel, Filament, Livewire, and SQLite locally through PHP-WebAssembly.
...
Run the prebuilt command from `LMS/`, where `.vercel/output/` is generated.
