...
stage_root="$(mktemp -d /tmp/lms-browser-demo.XXXXXX)"
...
COMPOSER_CACHE_DIR="${COMPOSER_CACHE_DIR:-/tmp/lms-composer-cache}" \
...
(
    ...
    export LIVEWIRE_RELEASE_TOKEN=lms-demo-runtime-v1
