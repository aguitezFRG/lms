...
class ViewCatalog extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('borrowPhysical')
                ...
                ->modalDescription('A borrow request will be submitted. Please collect the copy from the LMS once approved.')
    ...
    public function submitRequest(bool $digital): void
    {
        ...
        Notification::make()
            ...
            ->body('Your request is pending approval from the LMS staff.')
            ->success()
            ->send();
