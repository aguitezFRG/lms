...
class AdminOnboarding extends Page
{
    ...
    protected function getViewData(): array
    {
        ...
        $roleLabel = match ($roleValue) {
            'committee' => 'LMS Committee',
            'it' => 'IT Administrator',
            'staff/custodian' => 'LMS Staff',
        ...
        $bannerHtml = match ($roleValue) {
            'committee' => '<p class="mt-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">As an LMS Committee member, you oversee institutional policy and material curation. You have full access to all system features.</p>',
            ...
            'staff/custodian' => '<p class="mt-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">As LMS Staff, you handle day-to-day material access operations and borrow request processing.</p>',
