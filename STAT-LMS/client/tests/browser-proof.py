...
with sync_playwright() as playwright:
    ...
    try:
        ...
        inner_frame.get_by_label("First Name", exact=True).fill("Browser")
        inner_frame.get_by_label("Last Name", exact=True).fill("Probe")
        inner_frame.get_by_label("Display Name (Full)", exact=True).fill("Browser Probe")
        inner_frame.get_by_label("Email", exact=True).fill("browser.probe@demo.invalid")
        ...
        inner_frame.reload(wait_until="domcontentloaded", timeout=120_000)
